...
public class TestParseException {
    ...
    public void testNoArgConstructor() {
        FileParserException ex = new FileParserException();
    ...
    public void testStringConstructor() {
        ...
        FileParserException ex = new FileParserException(message);
    ...
    public void testThrowableConstructor() {
        ...
        FileParserException ex = new FileParserException(cause);
    ...
    public void testStringThrowableConstructor() {
        String message = "This is just a test.";
        Throwable cause = new Throwable();
        FileParserException ex = new FileParserException(message, cause);
        assertEquals(message, ex.getMessage());
        assertEquals(cause, ex.getCause());
    }
}
